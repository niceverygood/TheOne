...
- **핵심 차별점**: 가입 심사제(통과율 23%) + **4종 인증**(학력·재산·차량·부동산) + 무한 스와이프 금지(카드는 하루 3회 12·15·20시에 한 장씩) + 만남 신청제
- **탐색 구조**: 하단 탭 5개(오늘·둘러보기·매칭함·지난 카드·마이). 둘러보기는 **스와이프 덱이 아니라 페이지네이션 목록** — §3 금기는 그대로 지킨다.
